...
export class AlbumService {
  ...
  getAllAlbumes(): Observable<Album[]>{
    return this.http.get<Album[]>(`${this.backUrl}/albumes`)
  }
  ...
  agregarColeccionista(albumId: number, coleccionistaId:number): Observable<Album> {
    return this.http.post<Album>(`${this.backUrl}/usuario/${coleccionistaId}/album`, {"id_album": albumId})
  }
}
